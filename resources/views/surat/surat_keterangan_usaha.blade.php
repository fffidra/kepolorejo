                ...
                <div class="container-fluid">
                    ...
                    <div class="row bg-white rounded-3 pb-3 mb-3 mx-2">
                        <div class="page-title-box bg-light-subtle rounded-3 d-flex align-items-center justify-content-between px-3 py-2">
                            <h5>Data Permohonan Surat Keterangan Usaha</h5>
                            {{-- @if(Auth::user()->nama_jabatan == 'Inspektur Pembantu') --}}
                                <button data-bs-toggle="modal" data-bs-target="#tambahsptbaru" class="btn btn-primary">Ajukan Surat</button>
                            {{-- @endif --}}
                        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Formulir Pengajuan Surat Keterangan Usaha</h5>
                ...
                {{-- <form method="POST" action="{{ route('buat_spt') }}">  --}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="dasar_spt" class="col-md-2 col-form-label">NIK</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="dasar_spt" name="dasar_spt" required></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="untuk_spt" class="col-md-2 col-form-label">Nama Lengkap</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="untuk_spt" name="untuk_spt" required></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="untuk_spt" class="col-md-2 col-form-label">Nama Usaha</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="untuk_spt" name="untuk_spt" required></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="untuk_spt" class="col-md-2 col-form-label">Keperluan Pengajuan Surat</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="untuk_spt" name="untuk_spt" required></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="untuk_spt" class="col-md-2 col-form-label">Upload File</label>
                            <div class="col-md-9">
                                <textarea class="form-control" id="untuk_spt" name="untuk_spt" required></textarea>
                            </div>
                        </div>
