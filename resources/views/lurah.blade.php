                ...
                <div class="container-fluid">
                    ...
                    <div class="row bg-white rounded-3 pb-3 mb-3 mx-2">
                        <div class="page-title-box bg-light-subtle rounded-3 d-flex align-items-center justify-content-between px-3 py-2">
                            <h5>List Data Pejabat Kelurahan</h5>
                            <button data-bs-toggle="modal" data-bs-target="#tambahpejabatbaru" class="btn btn-primary">Tambah Pejabat</button>
                        </div>
...
@section('modal')
    {{-- MODAL DETAIL --}}
    <div class="modal fade" id="tambahpejabatbaru" tabindex="-1" aria-hidden="true">
